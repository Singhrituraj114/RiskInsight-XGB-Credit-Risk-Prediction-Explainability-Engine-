...
with res_left:
    ...
    fig_gauge = go.Figure(go.Indicator(
        ...
        value=prob * 100,
        delta={'reference': threshold * 100, 'increasing': {'color': "#FF3B5C"}, 'decreasing': {'color': "#00F5A0"}},
    ...
    fig_gauge.update_layout(height=280, margin=dict(t=30, b=10, l=20, r=20), paper_bgcolor="rgba(0,0,0,0)", font={"family": "Outfit"})
...
with res_right:
    ...
    shap_df['Color'] = np.where(shap_df['Impact'] > 0, '#FF3B5C', '#00F5A0')
